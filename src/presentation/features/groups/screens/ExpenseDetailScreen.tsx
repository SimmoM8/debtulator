...
import {
    ...
    TagChips,
    VerificationBadge,
} from "@/src/presentation/design-system/Badges";
...
import { explainSplit } from "@/src/domain/ledger/splits";
...
import type { DebtStatus, VerificationStatus } from "@/src/domain/models";
...
export function ExpenseDetailScreen() {
  ...
  async function exportPdf() {
    ...
    await shareExport(platform.sharing, uri, `${currentExpense.title} PDF`);
  }
