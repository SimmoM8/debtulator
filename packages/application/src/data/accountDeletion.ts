...
import type { AccountDeletionState, AuditLog, SyncConflict } from '@debtulator/domain/models';
...
export function buildAccountDeletionPlan(snapshot: AppSnapshot, userId: string): AccountDeletionPlan {
...
function conflictTouchesOwnedData(conflict: SyncConflict, snapshot: AppSnapshot, userId: string) {
