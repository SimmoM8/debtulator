import { CURRENCY_SYMBOL_PLACEMENT, CURRENCY_SYMBOLS } from '@debtulator/domain/finance/currencies';
import type { CurrencyCode, MoneyMap } from '@debtulator/domain/models';
