...
import { FloatingAddButton } from "@/src/presentation/design-system/Finance";
    ...
    () => [
      {
        items: [
          ...
          },
          {
            ...
            onPress: () => {
              setMenuOpen(false);
              router.push(routes.expenseForm());
            },
          },
          {
            label: "Add group",
