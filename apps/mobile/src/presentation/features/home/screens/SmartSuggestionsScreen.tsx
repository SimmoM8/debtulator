...
} from "@debtulator/domain/suggestions/smartSuggestions";
                ...
                <Button
                  ...
                  onPress={() => {
                    if (
                      ...
                      router.push(routes.debtDetail(suggestion.targetId));
                    } else if (
                      suggestion.targetType === "member" &&
                      suggestion.targetId
                    ) {
                      router.push(routes.memberDetail(suggestion.targetId));
                    } else {
                      router.push(routes.debts());
                    }
                  }}
                />
                <Button
