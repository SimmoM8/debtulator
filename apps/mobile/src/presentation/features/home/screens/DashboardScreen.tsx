...
import {
    ...
    activitySummary,
    buildUserActivity,
} from "@debtulator/domain/activity/activity";
...
const QUICK_ACTIONS: QuickAction[] = [
  { label: "Add debt", icon: "add-circle", href: routes.debtForm() },
  { label: "Record payment", icon: "card", href: routes.paymentForm() },
  { label: "Split bill", icon: "people", href: routes.expenseForm() },
  { label: "Add member", icon: "person-add", href: routes.memberForm() },
];
        ...
        <>
          <SectionTitle
            ...
            action={
              <SectionActionLink
                label="View all"
                onPress={() => router.push(routes.debts())}
              />
            }
          />
