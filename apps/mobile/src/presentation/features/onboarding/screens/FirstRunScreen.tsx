...
import { CurrencySelect } from '@/src/presentation/design-system/CurrencySelect';
import { Button, Card, PageHeader, Screen, TextField } from '@/src/presentation/design-system/Primitives';
        ...
        <View style={[styles.centerStage, { minHeight: Math.max(520, height - 180) }]}>
          ...
          <View style={[styles.secondaryActions, { maxWidth: width >= 900 ? 720 : 680 }]}>
            <Text style={styles.secondaryText}>
              New here?{' '}
              <Text style={styles.secondaryLink} onPress={() => router.push(routes.auth({ mode: 'signup', firstRun: '1' }))}>
                Create account
              </Text>
            </Text>
