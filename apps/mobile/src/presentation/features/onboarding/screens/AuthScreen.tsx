...
import { AnimatedBrandBar, AuthBackgroundPattern } from '@/src/presentation/components/auth/AuthFlowVisuals';
import {
  Button,
  Card,
  DropdownSelect,
...
} from '@/src/presentation/onboarding/onboardingOptions';
          ...
          <View style={[styles.signupActions, { maxWidth: width >= 900 ? 720 : 680 }]}>
            <Text style={styles.signupActionText}>
              ...
              <Text
                ...
                onPress={() => (firstRun ? router.replace(routes.firstRun()) : setMode('signin'))}
              >
                Sign in
              </Text>
            </Text>
            <Button
              ...
              variant="ghost"
              size="compact"
              onPress={() => (firstRun ? router.replace(routes.firstRun({ local: '1' })) : router.back())}
            />
          </View>
        </View>
      </Screen>
    ...
    <Screen
      footer={
        <Button
          ...
          icon="phone-portrait"
          variant="secondary"
          onPress={() => (firstRun ? router.replace(routes.firstRun()) : router.back())}
        />
      }
    >
