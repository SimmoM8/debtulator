...
import {
    ...
    shareBackupFile,
} from "@debtulator/application/data/backupRestore";
import {
...
import type { BackupMode } from "@debtulator/domain/models";
...
export function BackupRestoreScreen() {
  ...
  async function createBackup() {
    try {
      ...
      await shareBackupFile(platform.files, platform.sharing, backup);
