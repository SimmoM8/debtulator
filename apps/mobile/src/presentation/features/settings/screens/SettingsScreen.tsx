...
import { GlassCard, SettingsRow, StatCard } from "@/src/presentation/design-system/Finance";
import {
    Button,
    LoadingState,
    PageHeader,
...
export function SettingsScreen() {
    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              await collaboration.developmentData.resetHostedData();
  ...
  async function performFullLocalReset() {
    ...
    try {
      ...
      router.replace(routes.firstRun());
      if (signOutError) {
        Alert.alert(
          "Local data erased",
      ...
      <GlassCard tone="lavender">
        <View style={styles.sectionColumn}>
          ...
          <SettingsRow
            ...
            value="Open"
            onPress={() => router.push(routes.accessibility())}
          />
        </View>
      </GlassCard>
      ...
      <GlassCard tone="peach">
        <View style={styles.sectionColumn}>
          <SettingsRow
            ...
            onPress={() => router.push(routes.sync())}
          />
          <SettingsRow
            icon="cloud-outline"
            title="Backup"
            ...
            value="Open"
            onPress={() => router.push(routes.backup())}
          />
          <SettingsRow
            ...
            value="Open"
            onPress={() => router.push(routes.exportData())}
          />
        </View>
      </GlassCard>
