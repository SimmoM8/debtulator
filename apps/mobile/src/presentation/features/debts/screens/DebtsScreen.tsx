...
} from "@/src/presentation/components/DebtLedgerSection";
import {
...
import { GlassCard, SingleSelectFilterList } from "@/src/presentation/design-system/Finance";
...
import { entryDirectionText, participantName } from "@debtulator/domain/ledger/ledger";
    ...
    <Screen
      ...
      header={
        <CollectionPageHeader
          title="Debts"
          addLabel="Add debt"
          onAdd={() => router.push(routes.debtForm())}
            ...
            items: [
              {
                ...
                onPress: () => {
                  ...
                  router.push(routes.debtHistory());
                },
              },
              {
                label: "Open filters",
