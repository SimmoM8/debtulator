...
import { formatMoney, roundMoney } from "@debtulator/domain/finance/money";
...
export function PaymentFormScreen() {
  ...
  async function save() {
    ...
    const createPayment = async () => {
      ...
      const settlementGroupId = groupId ?? focusedEntry?.groupId;
      router.replace(
        settlementGroupId
          ? routes.groupSettlementDetail(result.settlement.id)
          : routes.debtSettlementDetail(result.settlement.id),
      );
    };
