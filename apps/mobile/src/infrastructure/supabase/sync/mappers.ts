...
import { withGeneratedObligations } from '@debtulator/domain/ledger/splits';
import type {
  Attachment,
  Comment,
  CurrencyCode,
...
import { createId } from '@debtulator/domain/shared/identifiers';
...
export function mapRemoteGroupToLocal(row: RemoteRow, snapshot: AppSnapshot): Group {
...
export function mapRemoteGroupParticipantToLocal(row: RemoteRow, snapshot: AppSnapshot): GroupParticipant {
...
export function mapLocalGroupMemberToRemote(member: SharedGroupMember, snapshot: AppSnapshot) {
  return {
...
export function mapRemoteGroupMemberToLocal(row: RemoteRow, snapshot: AppSnapshot): SharedGroupMember {
...
export function mapLocalExpenseToRemote(expense: SharedExpense, snapshot: AppSnapshot) {
...
export function mapRemoteExpensePayerToLocal(row: RemoteExpensePayer, snapshot: AppSnapshot): ExpensePayer {
  return {
...
export function mapLocalDebtToRemote(debt: Debt, snapshot: AppSnapshot, creatorUserId: string) {
...
export function mapLocalGroupDebtToRemote(debt: GroupDebt, snapshot: AppSnapshot) {
  return {
...
export function mapRemoteGroupDebtToLocal(row: RemoteRow, snapshot: AppSnapshot): GroupDebt {
...
export function mapLocalGroupVerificationToRemote(response: GroupVerificationResponse, snapshot: AppSnapshot) {
  return {
...
export function mapRemoteGroupVerificationToLocal(row: RemoteRow, snapshot: AppSnapshot): GroupVerificationResponse {
...
export function mapLocalPaymentToRemote(payment: Payment, snapshot: AppSnapshot) {
  return {
...
export function mapRemotePaymentToLocal(row: RemoteRow, snapshot: AppSnapshot): Payment {
...
export function mapLocalSettlementToRemote(settlement: Settlement, snapshot: AppSnapshot) {
  return {
...
export function mapRemoteSettlementToLocal(row: RemoteRow, snapshot: AppSnapshot): Settlement {
...
export function mapLocalSettlementLineToRemote(line: SettlementLine, snapshot: AppSnapshot) {
  return {
...
export function mapRemoteSettlementLineToLocal(row: RemoteRow, snapshot: AppSnapshot): SettlementLine {
...
export function mapLocalCommentToRemote(comment: Comment, snapshot: AppSnapshot) {
  return {
...
export function mapRemoteCommentToLocal(row: RemoteRow, snapshot: AppSnapshot): Comment {
...
export function mapLocalAttachmentToRemote(attachment: Attachment, snapshot: AppSnapshot) {
  return {
...
export function mapRemoteAttachmentToLocal(row: RemoteRow, snapshot: AppSnapshot): Attachment {
...
export function mapRemoteGroupInviteToLocal(row: RemoteRow, snapshot: AppSnapshot): GroupInvite {
...
export function mapRemoteGroupClaimToLocal(row: RemoteRow, snapshot: AppSnapshot): GroupMemberClaim {
...
export function mapRemoteDuplicateWarningToLocal(row: RemoteRow, snapshot: AppSnapshot): GroupDuplicateWarning {
...
export function mapRemoteActivityToLocal(row: RemoteRow, snapshot: AppSnapshot): GroupActivityLog {
...
function requiredRemoteTargetId(snapshot: AppSnapshot, targetType: string, localId: string) {
...
function requiredLocalTargetId(snapshot: AppSnapshot, targetType: string, remoteId: string) {
  if (targetType === 'expense') {
...
function mapSourceRecordIdToRemote(snapshot: AppSnapshot, sourceRecordType: string, localId: string) {
...
function mapSourceRecordIdToLocal(snapshot: AppSnapshot, sourceRecordType: string, remoteOrLocalId: string) {
  if (sourceRecordType === 'group_debt') {
...
function mapCommentAttachmentTargetToRemote(snapshot: AppSnapshot, targetType: string, localId: string) {
  switch (targetType) {
    case 'group':
...
function mapCommentAttachmentTargetToLocal(snapshot: AppSnapshot, targetType: string, remoteOrLocalId: string) {
  switch (targetType) {
    case 'group':
...
function mapActivityTargetToLocal(snapshot: AppSnapshot, targetType: string, remoteOrLocalId: string) {
...
function collectionForEntity(snapshot: AppSnapshot, entityType: EntityKind | 'expense_payer' | 'settlement_line') {
  switch (entityType) {
    case 'group':
