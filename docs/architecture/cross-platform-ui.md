...
2. Keep platform navigation differences in src/presentation/navigation/RootNavigator.tsx and src/presentation/navigation/RootNavigator.ios.tsx.
...
9. Keep NativeTabs isolated to the platform-resolved
   `src/presentation/navigation/AppTabs.ios.tsx` adapter. The route layout only
   re-exports that adapter. Do not manually position iOS tab affordances or
...
- Feature state and calculations:
  - src/presentation/features/members/useMembersScreenModel.ts
- Shared screens:
  - src/presentation/features/members/screens/*
- Route modules:
  - src/presentation/features/members/routes/*
- Canonical routes:
  - app/(tabs)/members/index.tsx
  - app/(tabs)/members/member/[id].tsx
  - app/(tabs)/members/member/form.tsx
- Legacy redirects:
  - app/member/[id].tsx
  - app/member/form.tsx
...
- Create feature screen-model hook under src/presentation/features/<feature>/.
